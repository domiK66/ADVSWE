...
UnitOfWork uow = new UnitOfWork();
  ...
  public async Task ShouldGetAquariumsForUser()
  {
    ...
    var user = await uow.User.Register(new User()
    {
      Firstname = "Mike",
      Lastname = "Kohl",
      Username = "shesh123",
    ...
    var aquarium = await uow.Aquarium.InsertOneAsync(new Aquarium()
    {
      Liters = 300,
      Height = 55,
      Depth = 35,
    ...
    var aquarium2 = await uow.Aquarium.InsertOneAsync(new Aquarium()
    {
      Liters = 300,
      Height = 55,
      Depth = 35,
    ...
    await uow.UserAquarium.InsertOneAsync(new UserAquarium()
    {
      UserID = user.ID,
